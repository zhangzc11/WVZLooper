...
####################option A:##################
##train a single BDT to discriminate signal with ttzzz backgrounds
##use emu events for training
##with ttzzz backgrounds included
##############################################
doAppend = False

root.gROOT.SetBatch(True)
test_name = 'xgb_wwz_vs_ttzzz_bVeto'
...
pwd = os.getcwd()
dataDir = pwd.replace("python", "data/All/bVeto/")
...
#bkg
bkgFileName    = dataDir + 'ttzzz.root'
...
variables = ['met_pt','lep3Id','lep4Id','lep3Pt','lep4Pt','ZPt','lep3dZ', 'lep4dZ','lep3MT','lep4MT','lep34MT','phi0','theta0','phi','theta1','theta2','MllN', 'pt_zeta', 'pt_zeta_vis', "nj", 'minDRJetToLep3','minDRJetToLep4', 'jet1Pt', 'jet2Pt', 'jet3Pt', 'jet4Pt', 'jet1BtagScore', 'jet2BtagScore', 'jet3BtagScore', 'jet4BtagScore']
variables_names = ['met_pt','lep3Id','lep4Id','lep3Pt','lep4Pt','ZPt','lep3dZ', 'lep4dZ','lep3MT','lep4MT','lep34MT','phi0','theta0','phi','theta1','theta2','Mll34', 'pt_zeta', 'pt_zeta_vis', "nj", 'minDRJToL3','minDRJToL4', 'jet1Pt', 'jet2Pt', 'jet3Pt', 'jet4Pt', 'jet1Btag', 'jet2Btag', 'jet3Btag', 'jet4Btag']
print(len(variables))
...
for idx in range(len(variables)):
        ...
        plt.hist(df_bkg[df_bkg[variables[idx]] > -999][variables[idx]], density=True, bins=50, alpha=1.0, histtype="step", lw=2, label="ttZ&ZZ")
...
model = xgb.XGBClassifier(max_depth=10, learning_rate=0.1, n_estimators=1000, verbosity=2, n_jobs=4, reg_lambda=0.5)
...
plt.hist(disc_bkg, density=True, bins=100, alpha=1.0, histtype="step", lw=2, label="ttZ&ZZ - test")
plt.hist(disc_bkg_train, density=True, bins=100, alpha=1.0, histtype="step", lw=2, label="ttZ&ZZ - train")
plt.yscale("log")
plt.xlim([0.0, 1.0])
