...
if [[ $1 == *"WVZ"* ]] || [[ $1 == *"Trilep"* ]]; then
    ...
    hadd -f outputs/${1}_${3}_${5}/${2}_${4}_${6}/zh_wwz.root   outputs/${1}/${2}/zh_wwz.root   outputs/${3}/${4}/zh_wwz.root   outputs/${5}/${6}/zh_wwz.root
    hadd -f outputs/${1}_${3}_${5}/${2}_${4}_${6}/wh_www.root   outputs/${1}/${2}/wh_www.root   outputs/${3}/${4}/wh_www.root   outputs/${5}/${6}/wh_www.root
    hadd -f outputs/${1}_${3}_${5}/${2}_${4}_${6}/wh_wzz.root   outputs/${1}/${2}/wh_wzz.root   outputs/${3}/${4}/wh_wzz.root   outputs/${5}/${6}/wh_wzz.root
    hadd -f outputs/${1}_${3}_${5}/${2}_${4}_${6}/zh_zzz.root   outputs/${1}/${2}/zh_zzz.root   outputs/${3}/${4}/zh_zzz.root   outputs/${5}/${6}/zh_zzz.root
