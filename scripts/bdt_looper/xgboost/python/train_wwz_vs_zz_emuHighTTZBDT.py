...
pwd = os.getcwd()
dataDir = pwd.replace("python", "data/All/emuHighTTZBDT/")
...
variables =   [	['met_pt_corr', 'met_pt', '$p_{T}^{miss}$ (GeV)', 100, 0, 500],
	     	['lep3Pt', 'lep3Pt', '$p_T^{l3}$ (GeV)', 100, 0, 500],
	     	['lep4Pt', 'lep4Pt', '$p_T^{l4}$ (GeV)', 100, 0, 500],
		['ZPt', 'ZPt', '$p_T^Z$ (GeV)', 100, 0, 500],
		['lep3dZ', 'lep3dZ', '$d_z^{l3}$', 100, -0.05, 0.05], 
		['lep4dZ', 'lep4dZ', '$d_z^{l4}$', 100, -0.05, 0.05],
		['lep3MT', 'lep3MT', '$m_T^{l3}$ (GeV)', 100, 0, 500],
		['lep4MT', 'lep4MT', '$m_T^{l4}$ (GeV)', 100, 0, 500],
		['MllN', 'Mll34', '$m_{ll}$ (GeV)', 100, 0, 500], 
		['pt_zeta', 'pt_zeta', '$P_{\zeta}$ (GeV)', 100, -500, 500],
		['pt_zeta_vis', 'pt_zeta_vis', '$P_{\zeta}^{vis}$ (GeV)', 100, 0, 500],
...
for idx in range(len(variables)):
        ...
        plt.hist(df_bkg[df_bkg[variables[idx][0]] > -999][variables[idx][0]], density=True, alpha=1.0, histtype="step", lw=3, label="ZZ", bins=variables[idx][3], range=(variables[idx][4], variables[idx][5]))
