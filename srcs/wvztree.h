...
class wvztree {
 ...
 protected: 
  ...
  float    disc_ttzzz_bVeto_;
  TBranch *disc_ttzzz_bVeto_branch;
  bool     disc_ttzzz_bVeto_isLoaded;
  float    disc_ttzzz_emu_;
  TBranch *disc_ttzzz_emu_branch;
  bool     disc_ttzzz_emu_isLoaded;
  float    disc_ttzzz_OffZ_;
  TBranch *disc_ttzzz_OffZ_branch;
  bool     disc_ttzzz_OffZ_isLoaded;
  float    disc_zz_emu_;
  TBranch *disc_zz_emu_branch;
  bool     disc_zz_emu_isLoaded;
  float    disc_zz_emuHighTTZBDT_;
  TBranch *disc_zz_emuHighTTZBDT_branch;
  bool     disc_zz_emuHighTTZBDT_isLoaded;
  float    disc_zz_OffZHighTTZBDT_;
  TBranch *disc_zz_OffZHighTTZBDT_branch;
  bool     disc_zz_OffZHighTTZBDT_isLoaded;
  float    disc_zz_OffZ_;
  TBranch *disc_zz_OffZ_branch;
  bool     disc_zz_OffZ_isLoaded;
  float    disc_ttz_nbAll_;
  TBranch *disc_ttz_nbAll_branch;
  bool     disc_ttz_nbAll_isLoaded;
  float    disc_ttz_bVeto_;
  TBranch *disc_ttz_bVeto_branch;
  bool     disc_ttz_bVeto_isLoaded;
  float    disc_ttz_emu_;
  TBranch *disc_ttz_emu_branch;
  bool     disc_ttz_emu_isLoaded;
  float    disc_ttz_OffZ_;
  TBranch *disc_ttz_OffZ_branch;
  bool     disc_ttz_OffZ_isLoaded;
  float    disc_multi_nbAll_;
  TBranch *disc_multi_nbAll_branch;
  bool     disc_multi_nbAll_isLoaded;
  float    disc_multi_emuHighTTZBDT_;
  TBranch *disc_multi_emuHighTTZBDT_branch;
  bool     disc_multi_emuHighTTZBDT_isLoaded;
  float    disc_multi_emu_;
  TBranch *disc_multi_emu_branch;
  bool     disc_multi_emu_isLoaded;
  float    disc_multi_OffZHighTTZBDT_;
  TBranch *disc_multi_OffZHighTTZBDT_branch;
  bool     disc_multi_OffZHighTTZBDT_isLoaded;
  float    disc_multi_OffZ_;
  TBranch *disc_multi_OffZ_branch;
  bool     disc_multi_OffZ_isLoaded;
public: 
...
void LoadAllBranches(); 
  ...
  const float &disc_ttzzz_bVeto();
  const float &disc_ttzzz_emu();
  const float &disc_ttzzz_OffZ();
  const float &disc_zz_emu();
  const float &disc_zz_emuHighTTZBDT();
  const float &disc_zz_OffZHighTTZBDT();
  const float &disc_zz_OffZ();
  const float &disc_ttz_nbAll();
  const float &disc_ttz_bVeto();
  const float &disc_ttz_emu();
  const float &disc_ttz_OffZ();
  const float &disc_multi_nbAll();
  const float &disc_multi_emuHighTTZBDT();
  const float &disc_multi_emu();
  const float &disc_multi_OffZ();
  const float &disc_multi_OffZHighTTZBDT();
