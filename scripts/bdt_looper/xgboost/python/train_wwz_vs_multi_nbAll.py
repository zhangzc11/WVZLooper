...
test_name = 'xgb_wwz_vs_multi_nbAll'
...
#bkg
bkgFileName    = dataDir + 'all_bkg.root'
...
zzFileName  = dataDir + 'zz.root'
ttzFileName  = dataDir + 'ttz.root'
wzFileName  = dataDir + 'wz.root'
twzFileName  = dataDir + 'twz.root'
otherFileName  = dataDir + 'other.root'
...
variables = ['met_pt','lep3Id','lep4Id','lep3Pt','lep4Pt','ZPt','lep3dZ', 'lep4dZ','lep3MT','lep4MT','lep34MT','phi0','theta0','phi','theta1','theta2','MllN', 'pt_zeta', 'pt_zeta_vis', "nj", "nb", 'minDRJetToLep3','minDRJetToLep4', 'jet1Pt', 'jet2Pt', 'jet3Pt', 'jet4Pt', 'jet1BtagScore', 'jet2BtagScore', 'jet3BtagScore', 'jet4BtagScore']
variables_names = ['met_pt','lep3Id','lep4Id','lep3Pt','lep4Pt','ZPt','lep3dZ', 'lep4dZ','lep3MT','lep4MT','lep34MT','phi0','theta0','phi','theta1','theta2','Mll34', 'pt_zeta', 'pt_zeta_vis', "nj", "nb", 'minDRJToL3','minDRJToL4', 'jet1Pt', 'jet2Pt', 'jet3Pt', 'jet4Pt', 'jet1Btag', 'jet2Btag', 'jet3Btag', 'jet4Btag']
print(len(variables))
...
params = {'max_depth':8, 'learning_rate':0.1, 'n_estimators':400, 'n_jobs':4, 'objective':'multi:softmax', 'num_class':num_class}
