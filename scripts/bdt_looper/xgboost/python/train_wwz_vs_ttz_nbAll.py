...
#variables = ["nb","nj", 'minDRJetToLep3','minDRJetToLep4', 'jet1Pt', 'jet2Pt', 'jet3Pt', 'jet4Pt', 'jet1BtagScore', 'jet2BtagScore', 'jet3BtagScore', 'jet4BtagScore', "MllN", "lep3MT", "lep4MT", "lep34MT", "ZPt", "M4l", "Pt4l"] #full

variables =   [	['nb', 'nb', 'N_b', 7, -0.5, 6.5],
	     	['minDRJetToLep3', 'minDRJToL3', '$min \Delta R(j, l3)$', 100, 0.0, 8.0],
	     	['minDRJetToLep4', 'minDRJToL4', '$min \Delta R(j, l4)$', 100, 0.0, 8.0],
	     	['jet1Pt', 'jet1Pt', '$p_T^{j1}$ (GeV)', 100, 0, 500],
	     	['jet1BtagScore', 'jet1Btag', 'jet1 Btag', 100, 0, 1],
	     	['jet2BtagScore', 'jet2Btag', 'jet2 Btag', 100, 0, 1],
	     	['jet3BtagScore', 'jet3Btag', 'jet3 Btag', 100, 0, 1],
	     	['jet4BtagScore', 'jet4Btag', 'jet4 Btag', 100, 0, 1],
		['MllN', 'Mll34', '$m_{ll}$ (GeV)', 100, 0, 500], 
	     	['ZPt', 'ZPt', '$p_T^Z$ (GeV)', 100, 0, 500],
		['M4l', 'M4l', '$m_{4l}$ (GeV)', 100, 0, 1000], 
		['Pt4l', 'Pt4l', '$p_T^{4l}$ (GeV)', 100, 0, 500]
	      ] 
...
for idx in range(len(variables)):
        ...
        plt.hist(df_signal[df_signal[variables[idx][0]] > -999][variables[idx][0]], density=True, alpha=1.0, histtype="step", lw=3, label="WWZ", bins=variables[idx][3], range=(variables[idx][4], variables[idx][5]))
        plt.hist(df_bkg[df_bkg[variables[idx][0]] > -999][variables[idx][0]], density=True, alpha=1.0, histtype="step", lw=3, label="ttZ", bins=variables[idx][3], range=(variables[idx][4], variables[idx][5]))
