...
test_name = 'xgb_wwz_vs_multi_OffZHighBDT1'
...
pwd = os.getcwd()
dataDir = pwd.replace("python", "data/All/OffZHighBDT1/")
...
params = {'max_depth':5, 'learning_rate':0.1, 'n_estimators':400, 'n_jobs':4, 'objective':'multi:softmax', 'num_class':num_class}
