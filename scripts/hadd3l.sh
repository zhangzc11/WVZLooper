...
if [[ $1 == *"Dilep"* ]]; then
    ...
    hadd -f wzz.root MC_wzz_amcatnlo_1_results.root 
    hadd -f zzz.root MC_zzz_amcatnlo_1_results.root 
    ...
    hadd -f higgs.root MC_ggh_hzz4l_powheg_1_results.root MC_tth_nonbb_powheg_1_results.root
